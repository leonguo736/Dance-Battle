...
reg [3:0]  fps_h; // fps high
reg [3:0]  fps_l; // fps low

reg [7:0]  rfps; // cum frames
reg [3:0]  rfps_l;
reg [3:0]  rfps_h;

reg [26:0] sec_cnt; // count number of seconds
reg        pre_vs; // from the camera, on vs change from 0 to 1, increment cum frames
wire       one_sec_mask; // every second fps = cum frames / 1 sec
