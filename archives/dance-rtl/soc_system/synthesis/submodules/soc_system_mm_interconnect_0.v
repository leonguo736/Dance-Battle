...
module soc_system_mm_interconnect_0 (
	...
	wire  [129:0] hex0_s1_agent_rf_source_data;                                                       // hex0_s1_agent:rf_source_data -> hex0_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] hex0_s1_agent_rsp_fifo_out_data;                                                    // hex0_s1_agent_rsp_fifo:out_data -> hex0_s1_agent:rf_sink_data
	...
	wire  [129:0] esp_uart_s1_agent_rf_source_data;                                                   // esp_uart_s1_agent:rf_source_data -> esp_uart_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] esp_uart_s1_agent_rsp_fifo_out_data;                                                // esp_uart_s1_agent_rsp_fifo:out_data -> esp_uart_s1_agent:rf_sink_data
	...
	wire  [128:0] hex0_s1_agent_rp_data;                                                              // hex0_s1_agent:rp_data -> router_010:sink_data
	...
	wire          esp_uart_s1_agent_rp_valid;                                                         // esp_uart_s1_agent:rp_valid -> router_011:sink_valid
	wire  [128:0] esp_uart_s1_agent_rp_data;                                                          // esp_uart_s1_agent:rp_data -> router_011:sink_data
	wire          esp_uart_s1_agent_rp_ready;                                                         // router_011:sink_ready -> esp_uart_s1_agent:rp_ready
	wire          esp_uart_s1_agent_rp_startofpacket;                                                 // esp_uart_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          esp_uart_s1_agent_rp_endofpacket;                                                   // esp_uart_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_led_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> hex0_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // hex0_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> hex0_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] hex0_s1_burst_adapter_source0_data;                                                 // hex0_s1_burst_adapter:source0_data -> hex0_s1_agent:cp_data
	wire          hex0_s1_burst_adapter_source0_ready;                                                // hex0_s1_agent:cp_ready -> hex0_s1_burst_adapter:source0_ready
	wire    [6:0] hex0_s1_burst_adapter_source0_channel;                                              // hex0_s1_burst_adapter:source0_channel -> hex0_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> esp_uart_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> esp_uart_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // esp_uart_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> esp_uart_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> esp_uart_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> esp_uart_s1_burst_adapter:sink0_endofpacket
	wire          esp_uart_s1_burst_adapter_source0_valid;                                            // esp_uart_s1_burst_adapter:source0_valid -> esp_uart_s1_agent:cp_valid
	wire  [128:0] esp_uart_s1_burst_adapter_source0_data;                                             // esp_uart_s1_burst_adapter:source0_data -> esp_uart_s1_agent:cp_data
	wire          esp_uart_s1_burst_adapter_source0_ready;                                            // esp_uart_s1_agent:cp_ready -> esp_uart_s1_burst_adapter:source0_ready
	wire    [6:0] esp_uart_s1_burst_adapter_source0_channel;                                          // esp_uart_s1_burst_adapter:source0_channel -> esp_uart_s1_agent:cp_channel
	...
	wire          esp_uart_s1_agent_rdata_fifo_out_valid;                                             // esp_uart_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] esp_uart_s1_agent_rdata_fifo_out_data;                                              // esp_uart_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          esp_uart_s1_agent_rdata_fifo_out_ready;                                             // avalon_st_adapter_006:in_0_ready -> esp_uart_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> esp_uart_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> esp_uart_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // esp_uart_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> esp_uart_s1_agent:rdata_fifo_sink_error
