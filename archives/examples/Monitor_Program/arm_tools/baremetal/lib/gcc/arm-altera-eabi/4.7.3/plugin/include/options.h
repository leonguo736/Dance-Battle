...
enum opt_code
{
  ...
  OPT_mcpu_ = 1011,                          /* -mcpu= */
  OPT_mfix_cortex_a9_volatile_hazards = 1012,/* -mfix-cortex-a9-volatile-hazards */
  OPT_mfix_cortex_m3_ldrd = 1013,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1014,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1015,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1016, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1017, */                    /* -mfp=3 */
  OPT_mfpe = 1018,                           /* -mfpe */
  /* OPT_mfpe_2 = 1019, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1020, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1021,                          /* -mfpu= */
  /* OPT_mhard_float = 1022, */              /* -mhard-float */
  OPT_mlittle_endian = 1023,                 /* -mlittle-endian */
  OPT_mlong_calls = 1024,                    /* -mlong-calls */
  OPT_mpic_register_ = 1025,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1026,            /* -mpoke-function-name */
  OPT_msched_prolog = 1027,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1028,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1029, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1030,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1031,                         /* -mthumb */
  OPT_mthumb_interwork = 1032,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1033,                  /* -mtls-dialect= */
  OPT_mtp_ = 1034,                           /* -mtp= */
  OPT_mtpcs_frame = 1035,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1036,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1037,                         /* -mtune= */
  ...
  OPT_pie = 1058,                            /* -pie */
  OPT_pipe = 1059,                           /* -pipe */
  OPT_print_file_name_ = 1060,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1061,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1062,          /* -print-multi-directory */
  OPT_print_multi_lib = 1063,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1064,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1065,                /* -print-multiarch */
