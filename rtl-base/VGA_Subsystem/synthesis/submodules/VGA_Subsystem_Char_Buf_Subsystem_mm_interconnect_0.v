// VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0 (
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_router router (
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_router_001 router_001 (
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (Sys_Clk_clk_clk),                                //       clk.clk
		.reset              (Char_Buf_DMA_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (Sys_Clk_clk_clk),                                //       clk.clk
		.reset               (Char_Buf_DMA_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (Sys_Clk_clk_clk),                                    //       clk.clk
		.reset              (Char_Buf_DMA_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (Sys_Clk_clk_clk),                                //       clk.clk
		.reset               (Char_Buf_DMA_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	VGA_Subsystem_Char_Buf_Subsystem_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
